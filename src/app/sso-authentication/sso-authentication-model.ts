...
export class OAuthConstants {
  public static AUTHORIZATION_URL = 'https://webaccessqa.kdc.capitalone.com/as/authorization.oauth2';
  public static TOKEN_URL = 'https://webaccessqa.kdc.capitalone.com/as/token.oauth2';
